...
large_flow: $(OBJECTS) large_flow.cpp
	$(CXX) $(CFLAGS) large_flow.cpp $(LDFLAGS) $(SNAP_OBJ) $(OBJECTS) $(LDLIBS) -o large_flow
...
all: d3c_test d3c_cocluster d3c_scores small_flow large_flow tripartite_flow anomaly
...
.PHONY : clean
clean :
	rm -rf *.o *~ d3c_test d3c_cocluster d3c_scores small_flow large_flow tripartite_flow anomaly
